...
sed 's:/Homer:/Homer,:g' < ../9_HOMER/MSH2KO_peaks_motifs/knownResults.txt | tr '\t' ',' > ../9_HOMER/MSH2KO_peaks_motifs/knownResults.csv
sed 's:/Homer:/Homer,:g' < ../9_HOMER/MSH2R4_peaks_motifs/knownResults.txt | tr '\t' ',' > ../9_HOMER/MSH2R4_peaks_motifs/knownResults.csv
