...
ggsave("../results/GO/MSH2_combined_go_enrichment_down.pdf",
       plot = go_combined_plot_down, width = 12, height = 16) } else {
         print("no down plot to print")
}

if(!is.null(go_combined_plot_up)){
ggsave("../results/GO/MSH2_combined_go_enrichment_up.pdf",
       plot = go_combined_plot_up, width = 12, height = 16) } else {
         print("no down plot to print")
       }

#Write the results to a file
write.csv(file="../results/GO/MSH2_combined_go_enrichment_up.csv",go_enrichment_up@result)
write.csv(file="../results/GO/MSH2_combined_go_enrichment_down.csv",go_enrichment_down@result)
