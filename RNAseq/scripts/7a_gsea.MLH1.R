...
#gene_mapping <- readRDS("../results/4-6_deseq2/MLH1_gene_mapping.Rds")
...
save_plots_to_pdf(c2_plots, "../results/7_GSEA/MLH1_gsea_c2.pdf")
save_plots_to_pdf(c5_plots, "../results/7_GSEA/MLH1_gsea_c5.pdf")
save_plots_to_pdf(h_plots, "../results/7_GSEA/MLH1_gsea_h.pdf")
save_plots_to_pdf(combined_plots, "../results/7_GSEA/MLH1_gsea_combined.pdf")
